...
- You can use the default values in the **Broker Setup** screen
  <img src="../sam/020-020-sam-init-3.png" alt="Sam Initialize - 3" style="display: block; margin: 20px auto; max-width: 70%; box-shadow: 0 4px 8px rgba(0,0,0,0.2); border-radius: 4px;">
...
- Select **bedrock-anthropic-claude-3-5-sonnet** from the model dropdown
  <img src="../sam/020-020-sam-init-4.png" alt="Sam Initialize - 4" style="display: block; margin: 20px auto; max-width: 70%; box-shadow: 0 4px 8px rgba(0,0,0,0.2); border-radius: 4px;">
